        ...
        <div className={styles["footer-container"]}>
            ...
            <div className={styles["content-footer"]}>
                ...
                <div className={styles["grid-right"]}>
                    <ul>
                        <li className= {styles.list}><Image src={github_icon}  width={20} height={20} className={styles.icon}/> <a href="https://github.com/Dakrfox" target="_blank">@Dakrfox</a> </li>
                        <li className= {styles.list}><Image src={linkedIn} width={20} height={20} className={styles.icon}/> <a href="https://linkedin.com/in/dakrfox" target="_blank">@dk-fox</a> </li>
